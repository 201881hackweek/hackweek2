...
public class Prop4 : MonoBehaviour
{
    ...
    public RectTransform Prop6_little;//与battery叠加获得的有电的手电筒
    ...
    void OnMouseUp()
    {
        ...
        if (hit && hit.collider.gameObject.tag == "battery")
        {
            ...
            RectTransform prop6 = Instantiate(Prop6_little, new Vector3(), new Quaternion(0, 0, 0, 0));//在背包栏生成有电的手电筒，位置位于battery
            ...
            propeventmanager.flashlight = true;//有手电筒了
