...
public class Prop1 : MonoBehaviour
{
    ...
    public RectTransform Prop3_little;//与dirtykey叠加出的光滑钥匙
    ...
    void OnMouseUp()
    {
        ...
        if (hit && hit.collider.gameObject.tag == "fruitknife")//如果碰到水果刀
        {
            ...
            RectTransform prop3 = Instantiate(Prop3_little, new Vector3(), new Quaternion(0, 0, 0, 0)) as RectTransform;//在背包栏生成铅灰，位置位于水果刀
