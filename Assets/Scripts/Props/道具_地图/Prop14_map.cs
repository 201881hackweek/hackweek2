...
public class Prop14_map : MonoBehaviour
{
    //地图里14酒
    private PropEventManager propeventmanager;
    public RectTransform Prop14_little;
    ...
    void Update()
    {
        ...
        {
            RectTransform prop14 = Instantiate(Prop14_little, new Vector3(), new Quaternion(0, 0, 0, 0));
            propeventmanager.Updategridposition(prop14);
            propeventmanager.Dialogbox.SetActive(true);
            propeventmanager.prepropnumber = 14;//捡拾道具后出现的提示信息
    ...
    private void OnMouseUp()
    {
        ...
        propeventmanager.Updategridposition(prop14);
        propeventmanager.Dialogbox.SetActive(true);
        propeventmanager.prepropnumber = 14;//捡拾到道具后出现的提示信息
        Destroy(transform.parent.gameObject);
    }
